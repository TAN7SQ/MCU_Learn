...
if(NOT DEFINED ARMGCC_ROOT_DIR)
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
        if(DEFINED ENV{QTOOLS})
            ...
            #set(ARMGCC_ROOT_DIR "D:/software/Embedded_tools/arm-gnu-toolchain-14.3.rel1-mingw-w64-x86_64-arm-none-eabi")
...
# -----------------------------------------------------------------------------
# 设置链接器通用选项 (注意这里使用了 nano.specs 来启用精简的 newlib-nano 库)
 #-u _printf_float -u _scanf_float 用于支持浮点数的 printf scanf 但是C文件需要syscalls.c 和 sysmem.c来实现底层函数,代码体积会增大)

#  set(CMAKE_EXE_LINKER_FLAGS
#     "-mthumb -static -Wl,--gc-sections,--cref -Wl,--print-memory-usage --specs=nano.specs -u _printf_float -u _scanf_float -T \"${CMAKE_CURRENT_LIST_DIR}/STM32F103XE_FLASH.ld\""
#     CACHE INTERNAL "Linker options"
# )

set(LINKER_FLAGS "-mthumb -static")
set(LINKER_FLAGS "${LINKER_FLAGS} -Wl,--gc-sections,--cref")
set(LINKER_FLAGS "${LINKER_FLAGS} -Wl,--print-memory-usage")
set(LINKER_FLAGS "${LINKER_FLAGS} --specs=nano.specs")
set(LINKER_FLAGS "${LINKER_FLAGS} -u _printf_float -u _scanf_float")
set(LINKER_FLAGS "${LINKER_FLAGS} -T \"${CMAKE_CURRENT_LIST_DIR}/STM32F103XE_FLASH.ld\"")

set(CMAKE_EXE_LINKER_FLAGS "${LINKER_FLAGS}" CACHE INTERNAL "Linker options")
